...
func TestVerifyPasswordIntegration(t *testing.T) {
	...
	testModels := []interface{}{&model.Patient{}, &model.Disease{}, &model.User{}, &model.Session{}, &model.Therapist{}, &model.Role{}, &model.Treatment{}, &model.Pricing{}, &model.Transaction{}, &model.PatientCode{}}
	t.Cleanup(func() {
